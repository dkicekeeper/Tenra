...
- **Next:** Phase 5 (Insights↔store unification: C-6/H-5/H-6/H-7), M-1 (deposit principalDelta), remaining Phase 6 (H-10 import partial-write atomicity), M-9 (unify FX-version signal), M-4 (recalculateAfterLinking actual amounts).
