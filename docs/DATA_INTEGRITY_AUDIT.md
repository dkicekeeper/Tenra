...
- **Next:** Phase 3 (loan/deposit debt single-source: C-3, M-1, M-4), Phase 5 (Insights↔store unification: C-6/H-5/H-6/H-7), Phase 6 (persistence: C-7 balance-zeroing, H-8 CSV parseType, H-10), plus M-9 (unify FX-version signal).
