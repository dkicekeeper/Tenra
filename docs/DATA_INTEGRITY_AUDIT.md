...
- **Next:** all High-severity residuals (H-6/H-7/H-10) closed; M-1 characterized + documented (unification deferred pending a product/eng decision on intended deposit-principal semantics). Remaining open items are Medium/Low (see §2 tables) and the noted pre-existing flaky matcher test.
