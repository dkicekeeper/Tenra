...
**Files:**
- Modify: `Tenra/ViewModels/AccountsViewModel.swift`
...
```bash
git add Tenra/Views/Accounts/Components/AccountsCarousel.swift
...
**Files:**
- Modify: `Tenra/Views/Accounts/Components/AccountRow.swift`
...
```bash
git add Tenra/Views/Accounts/Components/AccountRow.swift \
...
```bash
git add Tenra/Views/Accounts/AccountEditView.swift
...
```bash
grep -r "AccountActionView(" --include="*.swift" Tenra/
```
...
**Files:**
- Create: `Tenra/ViewModels/AccountActionViewModel.swift`
...
```bash
git add Tenra/ViewModels/AccountActionViewModel.swift
...
```bash
git add Tenra/Views/Accounts/AccountActionView.swift \
        Tenra/ViewModels/AccountActionViewModel.swift
