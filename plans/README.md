...
- DONE F13 import learns: statement account from the bank domain, the two sides of a transfer merge into one, "transfer to my account" is suggested from saved transfers, subcategories are picked and suggested (`9723d1da`). Apple Intelligence category tier still deferred.
